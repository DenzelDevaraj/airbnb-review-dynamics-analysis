# Unlocking Airbnb Review Dynamics in New York
...
## Key Findings
- Built a multiple linear regression model identifying **instant booking** and **flexible cancellation policies** as the strongest drivers of reviews per month
- Achieved ~65% improvement in predictive accuracy through feature selection and model refinement
- Identified that **hotel rooms** generate the highest average guest sentiment (0.44), while entire homes generate the most reviews
